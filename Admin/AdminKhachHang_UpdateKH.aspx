<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminPage.master" AutoEventWireup="true" CodeFile="AdminKhachHang_UpdateKH.aspx.cs" Inherits="Admin_AdminKhachHang_UpdateKH" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="style9">
        ...
        <tr>
            <td class="style10">
                <asp:Button ID="btnSua" runat="server" onclick="btnThem_Click" Text="Sửa" />
            </td>
            <td>
                &nbsp;</td>
        </tr>
