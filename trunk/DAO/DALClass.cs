...
namespace DAL
{
    class DALClass
    {
        private static string sqlConnectionString = @"Data Source=KHOADD-PC\SQLSERVER;Initial Catalog=QLBANHANG;Integrated Security=True;User ID=sa;Password=TMttc2012";
